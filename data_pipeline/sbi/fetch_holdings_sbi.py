...
MANUAL_SLUGS = {}
slug_file = Path(__file__).parent / "manual_slugs_sbi.json"
if slug_file.exists():
    ...
    print("WARNING: manual_slugs_sbi.json not found. Holdings extraction may fail for many funds.\n")
...
def main():
    ...
    cur.close()
    conn.close()
    print(f"Found {len(schemes)} SBI target schemes.\n")
