...
# 1 Load configuration & manual slugs
...
MANUAL_SLUGS = {}
try:
    with open("manual_slugs.json", "r", encoding="utf-8") as f:
...
def extract_metadata_from_page(scheme_name):
    ...
    for slug in slugs:
        ...
        try:
            ...
            # find the main fund data object
            ...
            return {
                "aum_cr": aum,                          # numeric or None
                "expense_ratio_direct": expense_num,    # numeric or None
                "benchmark_index": benchmark,           # string or None
                "fund_managers": managers,              # string or None
                "exit_load": exit_load                  # string (may be long text)
            }
        except Exception:
            continue
